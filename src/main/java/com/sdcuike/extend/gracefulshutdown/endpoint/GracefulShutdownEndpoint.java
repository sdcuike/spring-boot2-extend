package com.sdcuike.extend.gracefulshutdown.endpoint;
...
public class GracefulShutdownEndpoint implements ApplicationListener<ContextClosedEvent>, ApplicationContextAware {
            ...
            final Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        logger.info("We are now in OUT_OF_SERVICE mode...");
                        shutdownManager.pause();
                        // Pause the protocol.
                        logger.info("Graceful shutdown in progess... We don't accept new connection...... ");
                        // perform stop
                        shutdownManager.shutdown(timeout);
